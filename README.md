...
Your certificate and keys must be in pem format. In order to put them in the virtual machine, we recommend you to install Filezilla ([https://filezilla-project.org/download.php?type=client](https://filezilla-project.org/download.php?type=client)).
...
### SSH
#### Putty under windows
See [https://mediatemple.net/community/products/dv/204404604/using-ssh-in-putty-](https://mediatemple.net/community/products/dv/204404604/using-ssh-in-putty-)

### Filesharing between machine
See [https://www.one.com/en/support/faq/how-do-i-connect-to-an-sftp-server-with-filezilla](https://www.one.com/en/support/faq/how-do-i-connect-to-an-sftp-server-with-filezilla) for instructions on how to transfer files between two machines using SSH